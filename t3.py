    ...
    if userChoice == 'active':
        for pname in t3json:
            ...
            if k['completed'] == False:
                print("Projects: ", jsonToPython[k]['projectName'])
        ...
        for pname in t3json:
            ...
            if completed == total:
                ...
                print('{} of {} tasks are completed'.format(completed, total))
...
def t3Delete(arglist):
    ...
    for pname in t3json:
        print(type(pname))
        if pname == projectName:   # 'k['projectName']
    ...
    # TODO THIS PART HERE IS SUPER BROKEN
...
def _main():
    ...
    parser.add_argument("--add", help="Adds a Project to your list", action='store_true', default=False,
                        dest='addValue')
    parser.add_argument("--complete", help="Marks project on list as completed", action="store_true", default=False,
                        dest="completeValue")
    parser.add_argument("--delete", help="Removes Project from list", action='store_true', default=False,
                        dest='deleteValue')
    parser.add_argument("--report", help="Prints out basic report. Options: active/all/completed  (default=active)",
                        action='store_true', default=False, dest='reportValue', )
    parser.add_argument("--start",
                        help="Starts timing of Project, will overwrite existing tracked time if project is already being tracked",
                        action='store_true', default=False, dest='startValue')
    parser.add_argument("--stop/finish", help="Stops timing of Project, updates total run time", action='store_true',
                        default=False, dest="stopValue")
    parser.add_argument("--edit", help="Edits the time spent on a Project (in minutes)", action='store_true',
                        default=False, dest="editValue")
